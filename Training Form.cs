...
{
    public partial class FaceRecognitionTrainingForm : Form
    {
        ...
        public FaceRecognitionTrainingForm(FaceRecognitionLoginForm _Parent, string role, string username)
        {
        ...
        {
            //ATM THIS DELETE EVERYTHING IN THE DIRECTORY AND EVERY USER WILL LOSE THEIR FACE DATA WHICH WE DONT WANT THAT TO HAPPEN...
            if (Directory.Exists(Application.StartupPath + "/TrainedFaces/"))
            {
        ...
        private void ADD_BTN_Click(object sender, EventArgs e)
        {
            ...
            else if (resultImages.Count == num_faces_to_aquire)
            {
        ...
        private void FaceRecognitionTrainingForm_Load(object sender, EventArgs e)
        {
            //Debugging...
            //MessageBox.Show(actualRole, loggedInUsername);

            //Set textbox to username of person who is logged in for automation.
            NAME_PERSON.Text = loggedInUsername;
        }
        ...
        private void btnMenu_Click(object sender, EventArgs e)
        {
            ...
            //This makes it so it doesnt crash but soo many instances of camera is still running which is why it gets slower and slower each time...
            this.Dispose();
            this.DestroyHandle();
            this.Close();

            Menu clientForm = new Menu(actualRole, loggedInUsername);
            Admin adminForm = new Admin(actualRole, loggedInUsername);
